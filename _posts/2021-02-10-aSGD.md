...
| ------------ | ------------------ | ------------------ | ------------- |
| SGD-A        | :white_check_mark: | :x:                | $O(1/T)$      |
|              | :white_check_mark: | :white_check_mark: | $O(log(T)/T)$ |
| SGD-$\alpha$ | :white_check_mark: | :white_check_mark: | $O(1/T)$      |
| EPOCH-GD     | :white_check_mark: | :white_check_mark: | $O(1/T)$      |
