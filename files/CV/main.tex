...
\section{\centerline{\textcolor[rgb]{0, 0, 0}{Sept.2015-Jun.2019}}}
            ...
            \newline
            GPA: \textbf{3.81 /4.0} %, GRE: \textbf{322}
            Ranking : \textbf{3/95}
...
\iffalse
            \textbf{Main Courses:}\\
            Computer Architecture \hspace{20mm} Signal and Systems\\
            Introduction to Control \hspace{20mm} Discrete Mathematics\\
            Signal Detection and Estimation \hspace{7mm}  Introduction to Digital Integrated Circuit
\fi
