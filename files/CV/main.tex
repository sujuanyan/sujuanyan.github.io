...
% EDUCATION done
    ...
    \begin{itemize}
        ...
        \\ International Conference on Robotics and Automation (ICRA), IEEE, 2020. (accepted)
         %\href{http://arxiv.org/abs/1810.11967}{[pdf]}

         \item \textbf{J. Su}, M. E. Villanueva, B. Houska
         \\ A Tutorial on Koopman Operator Based Optimal Control
         \\ 59th IEEE Conference on Decision and Control, 2020 (submitted)
    %\item \RISSpaper
    \end{itemize}
